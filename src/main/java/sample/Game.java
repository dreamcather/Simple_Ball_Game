...
public class Game extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Hero hero =new Hero(-1,0,3,310,50,15,
                consumer -> scene.setOnKeyPressed(event -> consumer.accept(event.getCode())));
        gameState.addEnemy(new Enemy(1,0,3,50,50,15));
        gameState.addEnemy(new Enemy(1,2,3,100,50,15));
        gameState.addEnemy(new Enemy(1,3,3,150,50,15));
        gameState.addEnemy(new Enemy(1,4,3,200,50,15));
