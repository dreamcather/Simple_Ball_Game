...
public class RegularTwoBallCollision {
    ...
    public void collide() {
        ...
        Vector firstBallResultVector = GeometricalCalculation.vectorSum(firstBallVectorProjectionOnLinePerpendicularCollide,
                                                                        secondBallVectorProjectionOnLineParallelCollide);
        Vector secondBallResultVector = GeometricalCalculation.vectorSum(secondBallVectorProjectionOnLinePerpendicularCollide,
                                                                         firstBallVectorProjectionOnLineParallelCollide);
